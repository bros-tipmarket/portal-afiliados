...
- Guia da equipe: percurso de 19 etapas que destaca o elemento na tela e explica o que o PRD pede, o que a implementação entrega e o que segue pendente, com a referência (PD-*, AFP-*) e um selo por etapa — conforme o PRD, dado demonstrativo ou dependente de integração. Abre sozinho no primeiro acesso autenticado e fica disponível no botão “Guia da equipe”, no topo. Navega entre telas sozinho; setas do teclado avançam e Esc fecha. O conteúdo está em `lib/guide.ts`.
